    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
           ...
           DecimalFormat decimalForm = new DecimalFormat("#.##");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Transfer History</title>"); 
           ...
           +"</div></div>"  
            ...
            out.print("<label>Transfer History</lable>");
            ...
            out.print("<div class='tab_container' style='margin-top:65px;'> ");
                ...
                out.print("<th class='header'>Transfer ID</th>  ");
                ...
                out.print("<th class='header'>Name</th>  ");
                 out.print("</tr>  ");
                out.print("</thead>  ");
                String select = "select transferID, Amount, Date, transferhist.accountID as 'id'  ,Name  from accountdetails, transferhist where transferhist.accountID = accountdetails.accountID ";
               ...
               while(cn.rs.next()){
               out.print("<tr>");
               out.print("<td>"+cn.rs.getString("transferID")+"</td>");
