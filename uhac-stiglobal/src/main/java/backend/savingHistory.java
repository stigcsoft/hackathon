...
public class savingHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try{
           ...
           DecimalFormat decimalForm = new DecimalFormat("#.##");
            ...
            out.println("<title>Saving History</title>");  
           ...
           +"</div></div>"  
            ...
            out.print("<label>Account Transaction History</lable>");
            ...
            out.print("<div class='tab_container' style='margin-top:65px;'> ");
                ...
                out.print("<th class='header'>Amount Deposit</th>  ");
                out.print( "<th class='header'>Date Deposit</th>  "); 
                out.print( "<th class='header'>AccountID</th>  ");
                out.print("<th class='header'>Name</th>  ");
                 out.print("</tr>  ");
                out.print("</thead>  ");
                String select = "select TransID, Amount, Date, savinghist.accountID as 'id'  ,Name from accountdetails, savinghist where savinghist.accountID = accountdetails.accountID ";
               ...
               while(cn.rs.next()){
               out.print("<tr>");
               out.print("<td>"+cn.rs.getString("TransID")+"</td>");
